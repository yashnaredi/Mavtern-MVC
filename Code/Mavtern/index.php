...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>MAVTERN</span>
    </a>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            <h1>MAVTERN</h1>
            <p>Find your oppurtunity</p>
            <p><a class="btn btn-success btn-lg btn-color" href="jobs.php" role="button">Search Internships/Jobs</a></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 latest-job margin-bottom-20">
            <h1 class="text-center">Latest Internships/Jobs</h1>            
            <?php 
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Mavericks</h1>
            <p>Finding a internship just got easier. Create a profile and apply</p>            
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/browse.png" alt="Browse Jobs">
              <div class="caption">
                <h3 class="text-center">Browse Openings</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
        ...
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail company-img">
              ...
              <div class="caption">
                <h3 class="text-center">Post Jobs</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
    ...
    <section id="about" class="content-header">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="img/browse.png" class="img-responsive">
          </div>
          <div class="col-md-6 about-text margin-bottom-20">
            <p>The mavtern job portal application allows UTA students and recruiters to connect.The application provides the ability for internship seekers to create their accounts, upload their profile and resume, search for jobs, apply for jobs, view different  internship. The application provides the ability for companies to create their accounts, search candidates, create job postings, and view candidates applications.
            </p>
            <p>
              This website is used to provide a platform for potential candidates to get their dream job and excel in their career.
              This site can be used as a paving path for both companies and UTA students for a better life .
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="index.php">Mavtern</a>||<a href="sitemap.php">Sitemap</a>.</strong> All rights
    reserved.
    </div>
  </footer>
