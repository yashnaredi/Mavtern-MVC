...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b>Mavtern</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">UTA Candidate Login</p>
    ...
    <form method="post" action="checklogin.php">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
         <a href="user/index.php"> <button type="submit" class="btn btn-primary btn-block btn-flat">Sign In</button></a>
        </div>
        <!-- /.col -->
      </div>
    </form>
