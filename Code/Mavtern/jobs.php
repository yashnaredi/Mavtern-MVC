...
<div class="wrapper">
 ...
 <span class="logo-mini"><b>M</b>T</span>
      ...
      <span class="logo-lg">MAVTERN</span>
    </a>
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Dallas"><i class="fa fa-circle-o text-yellow"></i> Dallas</a></li>
                      <li><a href="" class="citySearch" data-target="Houston"><i class="fa fa-circle-o text-yellow"></i> Houston</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2018-2019 <a href="index.php">Mavtern</a>.</strong> All rights
    reserved.
    </div>
  </footer>
